...
class Work_Shortcode
{
    ...
    static function work_func($atts)
    {
        ...
        $html = "
        <div id='work-reviews' class='work'>
            <div class='work__box'>
                        ...
                        <div class='work__slider'>
                            <div class='work__item'>
                                <div class='work__text'>
                                    ...
                                    <span class='work__paragraph'>Клиниговая компания действительно чудо. Я человек пунктуальный , дорожу каждой минуткой и не люблю опаздывать сама. Ребята приехали во время, даже чуть раньше, свою работу сделали изумительно. Теперь наслаждаюсь своей чистой уютной квартиркой.</span>                                    
                                </div>
                                <div class='work__name'>Елена</div>
                            </div>
                        </div>                        
                    </div>
                    <div class='work__btn'>
